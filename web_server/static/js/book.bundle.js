import{a as _i,i as bi,l as Ce,p as on,b as ut,r as yi,s as Ii,c as vi,d as an,e as wi,o as Ei,f as Si,S as Ti,T as Tt}from"./cookie-consent-7gef3AxB.chunk.js";const ki=()=>{};var kt={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Li=()=>Ri().__FIREBASE_DEFAULTS__,Oi=()=>{if(typeof process>"u"||typeof kt>"u")return;const n=kt.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Ni=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&dn(n[1]);return e&&JSON.parse(e)},dt=()=>{try{return ki()||Li()||Oi()||Ni()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},Di=n=>{var e,t;return(t=(e=dt())==null?void 0:e.emulatorHosts)==null?void 0:t[n]},hn=()=>{var n;return(n=dt())==null?void 0:n.config},fn=n=>{var e;return(e=dt())==null?void 0:e[`_${n}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function y(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Ui(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(y())}function Bi(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function xi(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Fi(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function $i(){const n=y();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Hi(){try{return typeof indexedDB=="object"}catch{return!1}}function Vi(){return new Promise((n,e)=>{try{let t=!0;const i="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(i);r.onsuccess=()=>{r.result.close(),t||self.indexedDB.deleteDatabase(i),n(!0)},r.onupgradeneeded=()=>{t=!1},r.onerror=()=>{var s;e(((s=r.error)==null?void 0:s.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wi="FirebaseError";class F extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=Wi,Object.setPrototypeOf(this,F.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,de.prototype.create)}}class de{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},r=`${this.service}/${e}`,s=this.errors[e],o=s?ji(s,i):"Error",c=`${this.serviceName}: ${o} (${r}).`;return new F(r,c,i)}}function ji(n,e){return n.replace(qi,(t,i)=>{const r=e[i];return r!=null?String(r):`<${i}?>`})}const qi=/\{\$([^}]+)}/g;function zi(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function ee(n,e){if(n===e)return!0;const t=Object.keys(n),i=Object.keys(e);for(const r of t){if(!i.includes(r))return!1;const s=n[r],o=e[r];if(At(s)&&At(o)){if(!ee(s,o))return!1}else if(s!==o)return!1}for(const r of i)if(!t.includes(r))return!1;return!0}function At(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var g;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(g||(g={}));const tr={debug:g.DEBUG,verbose:g.VERBOSE,info:g.INFO,warn:g.WARN,error:g.ERROR,silent:g.SILENT},nr=g.INFO,ir={[g.DEBUG]:"log",[g.VERBOSE]:"log",[g.INFO]:"info",[g.WARN]:"warn",[g.ERROR]:"error"},rr=(n,e,...t)=>{if(e<n.logLevel)return;const i=new Date().toISOString(),r=ir[e];if(r)console[r](`[${i}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class pn{constructor(e){this.name=e,this._logLevel=nr,this._logHandler=rr,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in g))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?tr[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,g.DEBUG,...e),this._logHandler(this,g.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,g.VERBOSE,...e),this._logHandler(this,g.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,g.INFO,...e),this._logHandler(this,g.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,g.WARN,...e),this._logHandler(this,g.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,g.ERROR,...e),this._logHandler(this,g.ERROR,...e)}}const sr=(n,e)=>e.some(t=>n instanceof t);let Ct,Pt;function or(){return Ct||(Ct=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ar(){return Pt||(Pt=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const mn=new WeakMap,Qe=new WeakMap,gn=new WeakMap,je=new WeakMap,ft=new WeakMap;function cr(n){const e=new Promise((t,i)=>{const r=()=>{n.removeEventListener("success",s),n.removeEventListener("error",o)},s=()=>{t(M(n.result)),r()},o=()=>{i(n.error),r()};n.addEventListener("success",s),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&mn.set(t,n)}).catch(()=>{}),ft.set(e,n),e}function lr(n){if(Qe.has(n))return;const e=new Promise((t,i)=>{const r=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",o),n.removeEventListener("abort",o)},s=()=>{t(),r()},o=()=>{i(n.error||new DOMException("AbortError","AbortError")),r()};n.addEventListener("complete",s),n.addEventListener("error",o),n.addEventListener("abort",o)});Qe.set(n,e)}let Ze={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Qe.get(n);if(e==="objectStoreNames")return n.objectStoreNames||gn.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return M(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function ur(n){Ze=n(Ze)}function dr(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const i=n.call(qe(this),e,...t);return gn.set(i,e.sort?e.sort():[e]),M(i)}:ar().includes(n)?function(...e){return n.apply(qe(this),e),M(mn.get(this))}:function(...e){return M(n.apply(qe(this),e))}}function hr(n){return typeof n=="function"?dr(n):(n instanceof IDBTransaction&&lr(n),sr(n,or())?new Proxy(n,Ze):n)}function M(n){if(n instanceof IDBRequest)return cr(n);if(je.has(n))return je.get(n);const e=hr(n);return e!==n&&(je.set(n,e),ft.set(e,n)),e}const qe=n=>ft.get(n);function fr(n,e,{blocked:t,upgrade:i,blocking:r,terminated:s}={}){const o=indexedDB.open(n,e),c=M(o);return i&&o.addEventListener("upgradeneeded",a=>{i(M(o.result),a.oldVersion,a.newVersion,M(o.transaction),a)}),t&&o.addEventListener("blocked",a=>t(a.oldVersion,a.newVersion,a)),c.then(a=>{s&&a.addEventListener("close",()=>s()),r&&a.addEventListener("versionchange",l=>r(l.oldVersion,l.newVersion,l))}).catch(()=>{}),c}const pr=["get","getKey","getAll","getAllKeys","count"],mr=["put","add","delete","clear"],ze=new Map;function Rt(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(ze.get(e))return ze.get(e);const t=e.replace(/FromIndex$/,""),i=e!==t,r=mr.includes(t);if(!(t in(i?IDBIndex:IDBObjectStore).prototype)||!(r||pr.includes(t)))return;const s=async function(o,...c){const a=this.transaction(o,r?"readwrite":"readonly");let l=a.store;return i&&(l=l.index(c.shift())),(await Promise.all([l[t](...c),r&&a.done]))[0]};return ze.set(e,s),s}ur(n=>({...n,get:(e,t,i)=>Rt(e,t)||n.get(e,t,i),has:(e,t)=>!!Rt(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gr{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(_r(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function _r(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const et="@firebase/app",Lt="0.15.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R=new pn("@firebase/app"),br="@firebase/app-compat",yr="@firebase/analytics-compat",Ir="@firebase/analytics",vr="@firebase/app-check-compat",wr="@firebase/app-check",Er="@firebase/auth",Sr="@firebase/auth-compat",Tr="@firebase/database",kr="@firebase/data-connect",Ar="@firebase/database-compat",Cr="@firebase/functions",Pr="@firebase/functions-compat",Rr="@firebase/installations",Lr="@firebase/installations-compat",Or="@firebase/messaging",Nr="@firebase/messaging-compat",Dr="@firebase/performance",Mr="@firebase/performance-compat",Ur="@firebase/remote-config",Br="@firebase/remote-config-compat",xr="@firebase/storage",Fr="@firebase/storage-compat",$r="@firebase/firestore",Hr="@firebase/ai",Vr="@firebase/firestore-compat",Wr="firebase",jr="12.16.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pe=new Map,zr=new Map,nt=new Map;function Ot(n,e){try{n.container.addComponent(e)}catch(t){R.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function ae(n){const e=n.name;if(nt.has(e))return R.debug(`There were multiple attempts to register component ${e}.`),!1;nt.set(e,n);for(const t of Pe.values())Ot(t,n);for(const t of zr.values())Ot(t,n);return!0}function _n(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function E(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fe=jr;function bn(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i={name:tt,automaticDataCollectionEnabled:!0,...e},r=i.name;if(typeof r!="string"||!r)throw U.create("bad-app-name",{appName:String(r)});if(t||(t=hn()),!t)throw U.create("no-options");const s=Pe.get(r);if(s){if(ee(t,s.options)&&ee(i,s.config))return s;throw U.create("duplicate-app",{appName:r})}const o=new er(r);for(const a of nt.values())o.addComponent(a);const c=new Kr(t,i,o);return Pe.set(r,c),c}function Jr(n=tt){const e=Pe.get(n);if(!e&&n===tt&&hn())return bn();if(!e)throw U.create("no-app",{appName:n});return e}function Y(n,e,t){let i=qr[n]??n;t&&(i+=`-${t}`);const r=i.match(/\s|\//),s=e.match(/\s|\//);if(r||s){const o=[`Unable to register library "${i}" with version "${e}":`];r&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&s&&o.push("and"),s&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),R.warn(o.join(" "));return}ae(new te(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yr="firebase-heartbeat-database",Xr=1,ce="firebase-heartbeat-store";let Ge=null;function yn(){return Ge||(Ge=fr(Yr,Xr,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(ce)}catch(t){console.warn(t)}}}}).catch(n=>{throw U.create("idb-open",{originalErrorMessage:n.message})})),Ge}async function Qr(n){try{const t=(await yn()).transaction(ce),i=await t.objectStore(ce).get(In(n));return await t.done,i}catch(e){if(e instanceof F)R.warn(e.message);else{const t=U.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});R.warn(t.message)}}}async function Nt(n,e){try{const i=(await yn()).transaction(ce,"readwrite");await i.objectStore(ce).put(e,In(n)),await i.done}catch(t){if(t instanceof F)R.warn(t.message);else{const i=U.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});R.warn(i.message)}}}function In(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ss(n){ae(new te("platform-logger",e=>new gr(e),"PRIVATE")),ae(new te("heartbeat",e=>new ts(e),"PRIVATE")),Y(et,Lt,n),Y(et,Lt,"esm2020"),Y("fire-js","")}ss("");var os="firebase",as="12.16.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Y(os,as,"app");function vn(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const cs=vn,wn=new de("auth","Firebase",vn());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Re=new pn("@firebase/auth");function ls(n,...e){Re.logLevel<=g.WARN&&Re.warn(`Auth (${fe}): ${n}`,...e)}function Ee(n,...e){Re.logLevel<=g.ERROR&&Re.error(`Auth (${fe}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function T(n,...e){throw mt(n,...e)}function w(n,...e){return mt(n,...e)}function pt(n,e,t){const i={...cs(),[e]:t};return new de("auth","Firebase",i).create(e,{appName:n.name})}function j(n){return pt(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function us(n,e,t){const i=t;if(!(e instanceof i))throw i.name!==e.constructor.name&&T(n,"argument-error"),pt(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function mt(n,...e){if(typeof n!="string"){const t=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=n.name),n._errorFactory.create(t,...i)}return wn.create(n,...e)}function f(n,e,...t){if(!n)throw mt(e,...t)}function C(n){const e="INTERNAL ASSERTION FAILED: "+n;throw Ee(e),new Error(e)}function L(n,e){n||C(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function it(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function ds(){return Ut()==="http:"||Ut()==="https:"}function Ut(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pe{constructor(e,t){this.shortDelay=e,this.longDelay=t,L(t>e,"Short delay should be less than long delay!"),this.isMobile=Ui()||Fi()}get(){return hs()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ms=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],gs=new pe(3e4,6e4);function _t(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function re(n,e,t,i,r={}){return Sn(n,r,async()=>{let s={},o={};i&&(e==="GET"?o=i:s={body:JSON.stringify(i)});const c=he({...o,key:n.config.apiKey}).slice(1),a=await n._getAdditionalHeaders();a["Content-Type"]="application/json",n.languageCode&&(a["X-Firebase-Locale"]=n.languageCode);const l={method:e,headers:a,...s};return Bi()||(l.referrerPolicy="strict-origin-when-cross-origin"),n.emulatorConfig&&ht(n.emulatorConfig.host)&&(l.credentials="include"),En.fetch()(await Tn(n,n.config.apiHost,t,c),l)})}async function Sn(n,e,t){n._canInitEmulator=!1;const i={...ps,...e};try{const r=new bs(n),s=await Promise.race([t(),r.promise]);r.clearNetworkTimeout();const o=await s.json();if("needConfirmation"in o)throw Ie(n,"account-exists-with-different-credential",o);if(s.ok&&!("errorMessage"in o))return o;{const c=s.ok?o.errorMessage:o.error.message,[a,l]=c.split(" : ");if(a==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ie(n,"credential-already-in-use",o);if(a==="EMAIL_EXISTS")throw Ie(n,"email-already-in-use",o);if(a==="USER_DISABLED")throw Ie(n,"user-disabled",o);const u=i[a]||a.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw pt(n,u,l);T(n,u)}}catch(r){if(r instanceof F)throw r;T(n,"network-request-failed",{message:String(r)})}}async function _s(n,e,t,i,r={}){const s=await re(n,e,t,i,r);return"mfaPendingCredential"in s&&T(n,"multi-factor-auth-required",{_serverResponse:s}),s}async function Tn(n,e,t,i){const r=`${e}${t}?${i}`,s=n,o=s.config.emulator?gt(n.config,r):`${n.config.apiScheme}://${r}`;return ms.includes(t)&&(await s._persistenceManagerAvailable,s._getPersistenceType()==="COOKIE")?s._getPersistence()._getFinalTarget(o).toString():o}class bs{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i(w(this.auth,"network-request-failed")),gs.get())})}}function Ie(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const r=w(n,e,i);return r.customData._tokenResponse=t,r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ys(n,e){return re(n,"POST","/v1/accounts:delete",e)}async function Le(n,e){return re(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oe(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Is(n,e=!1){const t=$(n),i=await t.getIdToken(e),r=bt(i);f(r&&r.exp&&r.auth_time&&r.iat,t.auth,"internal-error");const s=typeof r.firebase=="object"?r.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:r,token:i,authTime:oe(Ke(r.auth_time)),issuedAtTime:oe(Ke(r.iat)),expirationTime:oe(Ke(r.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function Ke(n){return Number(n)*1e3}function bt(n){const[e,t,i]=n.split(".");if(e===void 0||t===void 0||i===void 0)return Ee("JWT malformed, contained fewer than 3 sections"),null;try{const r=dn(t);return r?JSON.parse(r):(Ee("Failed to decode base64 JWT payload"),null)}catch(r){return Ee("Caught error parsing JWT payload as JSON",r==null?void 0:r.toString()),null}}function Bt(n){const e=bt(n);return f(e,"internal-error"),f(typeof e.exp<"u","internal-error"),f(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function le(n,e,t=!1){if(t)return e;try{return await e}catch(i){throw i instanceof F&&vs(i)&&n.auth.currentUser===n&&await n.auth.signOut(),i}}function vs({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ts(n,e){const t=await Sn(n,{},async()=>{const i=he({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:s}=n.config,o=await Tn(n,r,"/v1/token",`key=${s}`),c=await n._getAdditionalHeaders();c["Content-Type"]="application/x-www-form-urlencoded";const a={method:"POST",headers:c,body:i};return n.emulatorConfig&&ht(n.emulatorConfig.host)&&(a.credentials="include"),En.fetch()(o,a)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function ks(n,e){return re(n,"POST","/v2/accounts:revokeToken",_t(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(n,e,t){return`firebase:${n}:${e}:${t}`}class Q{constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:r,name:s}=this.auth;this.fullUserKey=Se(this.userKey,r.apiKey,s),this.fullPersistenceKey=Se("persistence",r.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Le(this.auth,{idToken:e}).catch(()=>{});return t?v._fromGetAccountInfoResponse(this.auth,t,e):null}return v._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new Q(P(Ft),e,i);const r=(await Promise.all(t.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let s=r[0]||P(Ft);const o=Se(i,e.config.apiKey,e.name);let c=null;for(const l of t)try{const u=await l._get(o);if(u){let d;if(typeof u=="string"){const h=await Le(e,{idToken:u}).catch(()=>{});if(!h)break;d=await v._fromGetAccountInfoResponse(e,h,u)}else d=v._fromJSON(e,u);l!==s&&(c=d),s=l;break}}catch{}const a=r.filter(l=>l._shouldAllowMigration);return!s._shouldAllowMigration||!a.length?new Q(s,e,i):(s=a[0],c&&await s._set(o,c.toJSON()),await Promise.all(t.map(async l=>{if(l!==s)try{await l._remove(o)}catch{}})),new Q(s,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $t(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ln(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Cn(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Nn(e))return"Blackberry";if(Dn(e))return"Webos";if(Pn(e))return"Safari";if((e.includes("chrome/")||Rn(e))&&!e.includes("edge/"))return"Chrome";if(On(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Cn(n=y()){return/firefox\//i.test(n)}function Pn(n=y()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Rn(n=y()){return/crios\//i.test(n)}function Ln(n=y()){return/iemobile/i.test(n)}function On(n=y()){return/android/i.test(n)}function Nn(n=y()){return/blackberry/i.test(n)}function Dn(n=y()){return/webos/i.test(n)}function yt(n=y()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function As(n=y()){var e;return yt(n)&&!!((e=window.navigator)!=null&&e.standalone)}function Cs(){return $i()&&document.documentMode===10}function Mn(n=y()){return yt(n)||On(n)||Dn(n)||Nn(n)||/windows phone/i.test(n)||Ln(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Un(n,e=[]){let t;switch(n){case"Browser":t=$t(y());break;case"Worker":t=`${$t(y())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${fe}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rs(n,e={}){return re(n,"GET","/v2/passwordPolicy",_t(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let It={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function Ds(n){It=n}function Ms(n){return It.loadJS(n)}function Us(){return It.gapiScript}function Bs(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xs(n,e){const t=_n(n,"auth");if(t.isInitialized()){const r=t.getImmediate(),s=t.getOptions();if(ee(s,e??{}))return r;T(r,"already-initialized")}return t.initialize({options:e})}function Fs(n,e){const t=(e==null?void 0:e.persistence)||[],i=(Array.isArray(t)?t:[t]).map(P);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function $s(n,e,t){const i=Be(n);f(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const r=!1,s=Bn(e),{host:o,port:c}=Hs(e),a=c===null?"":`:${c}`,l={url:`${s}//${o}${a}/`},u=Object.freeze({host:o,port:c,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:r})});if(!i._canInitEmulator){f(i.config.emulator&&i.emulatorConfig,i,"emulator-config-failed"),f(ee(l,i.config.emulator)&&ee(u,i.emulatorConfig),i,"emulator-config-failed");return}i.config.emulator=l,i.emulatorConfig=u,i.settings.appVerificationDisabledForTesting=!0,ht(o)?Yi(`${s}//${o}${a}`):Vs()}function Bn(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Hs(n){const e=Bn(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",r=/^(\[[^\]]+\])(:|$)/.exec(i);if(r){const s=r[1];return{host:s,port:Vt(i.substr(s.length+1))}}else{const[s,o]=i.split(":");return{host:s,port:Vt(o)}}}function Vt(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Vs(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Z(n,e){return _s(n,"POST","/v1/accounts:signInWithIdp",_t(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ne{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,i,r=!1){const s=await v._fromIdTokenResponse(e,i,r),o=Wt(i);return new ne({user:s,providerId:o,_tokenResponse:i,operationType:t})}static async _forOperation(e,t,i){await e._updateTokensIfNecessary(i,!0);const r=Wt(i);return new ne({user:e,providerId:r,_tokenResponse:i,operationType:t})}}function Wt(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ne extends F{constructor(e,t,i,r){super(t.code,t.message),this.operationType=i,this.user=r,Object.setPrototypeOf(this,Ne.prototype),this.customData={appName:e.name,tenantId:e.tenantId??void 0,_serverResponse:t.customData._serverResponse,operationType:i}}static _fromErrorAndOperation(e,t,i,r){return new Ne(e,t,i,r)}}function Fn(n,e,t,i){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(s=>{throw s.code==="auth/multi-factor-auth-required"?Ne._fromErrorAndOperation(n,s,e,i):s})}async function js(n,e,t=!1){const i=await le(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return ne._forOperation(n,"link",i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zs(n,e,t=!1){if(E(n.app))return Promise.reject(j(n));const i="signIn",r=await Fn(n,i,e),s=await ne._fromIdTokenResponse(n,i,r);return t||await n._updateCurrentUser(s.user),s}function Gs(n,e,t,i){return $(n).onIdTokenChanged(e,t,i)}function Ks(n,e,t){return $(n).beforeAuthStateChanged(e,t)}function Js(n,e,t,i){return $(n).onAuthStateChanged(e,t,i)}function Ys(n){return $(n).signOut()}const De="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(De,"1"),this.storage.removeItem(De),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xe{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(r=>r.isListeningto(e));if(t)return t;const i=new xe(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:i,eventType:r,data:s}=t.data,o=this.handlersMap[r];if(!(o!=null&&o.size))return;t.ports[0].postMessage({status:"ack",eventId:i,eventType:r});const c=Array.from(o).map(async l=>l(t.origin,s)),a=await eo(c);t.ports[0].postMessage({status:"done",eventId:i,eventType:r,response:a})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}xe.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jn(){return typeof S().WorkerGlobalScope<"u"&&typeof S().importScripts=="function"}async function io(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function ro(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function so(){return jn()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Et extends xn{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Z(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Z(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Z(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function fo(n){return zs(n.auth,new Et(n),n.bypassAuthState)}function po(n){const{auth:e,user:t}=n;return f(t,e,"internal-error"),qs(t,new Et(n),n.bypassAuthState)}async function mo(n){const{auth:e,user:t}=n;return f(t,e,"internal-error"),js(t,new Et(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yn{constructor(e,t,i,r,s=!1){this.auth=e,this.resolver=i,this.user=r,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:r,tenantId:s,error:o,type:c}=e;if(o){this.reject(o);return}const a={auth:this.auth,requestUri:t,sessionId:i,tenantId:s||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(c)(a))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return fo;case"linkViaPopup":case"linkViaRedirect":return mo;case"reauthViaPopup":case"reauthViaRedirect":return po;default:T(this.auth,"internal-error")}}resolve(e){L(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){L(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const go=new pe(2e3,1e4);async function Xn(n,e,t){if(E(n.app))return Promise.reject(w(n,"operation-not-supported-in-this-environment"));const i=Be(n);us(n,e,vt);const r=Jn(i,t);return new W(i,"signInViaPopup",e,r).executeNotNull()}class W extends Yn{constructor(e,t,i,r,s){super(e,t,r,s),this.provider=i,this.authWindow=null,this.pollId=null,W.currentPopupAction&&W.currentPopupAction.cancel(),W.currentPopupAction=this}async executeNotNull(){const e=await this.execute();return f(e,this.auth,"internal-error"),e}async onExecution(){L(this.filter.length===1,"Popup operations only handle one event");const e=wt();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],e),this.authWindow.associatedEvent=e,this.resolver._originValidation(this.auth).catch(t=>{this.reject(t)}),this.resolver._isIframeWebStorageSupported(this.auth,t=>{t||this.reject(w(this.auth,"web-storage-unsupported"))}),this.pollUserCancellation()}get eventId(){var e;return((e=this.authWindow)==null?void 0:e.associatedEvent)||null}cancel(){this.reject(w(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,W.currentPopupAction=null}pollUserCancellation(){const e=()=>{var t,i;if((i=(t=this.authWindow)==null?void 0:t.window)!=null&&i.closed){this.pollId=window.setTimeout(()=>{this.pollId=null,this.reject(w(this.auth,"popup-closed-by-user"))},8e3);return}this.pollId=window.setTimeout(e,go.get())};e()}}W.currentPopupAction=null;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _o="pendingRedirect",Te=new Map;class bo extends Yn{constructor(e,t,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,i),this.eventId=null}async execute(){let e=Te.get(this.auth._key());if(!e){try{const i=await yo(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(t){e=()=>Promise.reject(t)}Te.set(this.auth._key(),e)}return this.bypassAuthState||Te.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function yo(n,e){const t=wo(e),i=vo(n);if(!await i._isAvailable())return!1;const r=await i._get(t)==="true";return await i._remove(t),r}function Io(n,e){Te.set(n._key(),e)}function vo(n){return P(n._redirectPersistence)}function wo(n){return Se(_o,n.config.apiKey,n.name)}async function Eo(n,e,t=!1){if(E(n.app))return Promise.reject(j(n));const i=Be(n),r=Jn(i,e),o=await new bo(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So=600*1e3;class To{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!ko(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!Qn(e)){const r=((i=e.error.code)==null?void 0:i.split("auth/")[1])||"internal-error";t.onError(w(this.auth,r))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=So&&this.cachedEventUids.clear(),this.cachedEventUids.has(zt(e))}saveEventToCache(e){this.cachedEventUids.add(zt(e)),this.lastProcessedEventTime=Date.now()}}function zt(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function Qn({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function ko(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Qn(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ao(n,e={}){return re(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oo=new pe(3e4,6e4);function Gt(){const n=S().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function No(n){return new Promise((e,t)=>{var r,s,o;function i(){Gt(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Gt(),t(w(n,"network-request-failed"))},timeout:Oo.get()})}if((s=(r=S().gapi)==null?void 0:r.iframes)!=null&&s.Iframe)e(gapi.iframes.getContext());else if((o=S().gapi)!=null&&o.load)i();else{const c=Bs("iframefcb");return S()[c]=()=>{gapi.load?i():t(w(n,"network-request-failed"))},Ms(`${Us()}?onload=${c}`).catch(a=>t(a))}}).catch(e=>{throw ke=null,e})}let ke=null;function Do(n){return ke=ke||No(n),ke}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mo=new pe(5e3,15e3),Uo="__/auth/iframe",Bo="emulator/auth/iframe",xo={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Fo=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function $o(n){const e=n.config;f(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?gt(e,Bo):`https://${n.config.authDomain}/${Uo}`,i={apiKey:e.apiKey,appName:n.name,v:fe},r=Fo.get(n.config.apiHost);r&&(i.eid=r);const s=n._getFrameworks();return s.length&&(i.fw=s.join(",")),`${t}?${he(i).slice(1)}`}async function Ho(n){const e=await Do(n),t=S().gapi;return f(t,n,"internal-error"),e.open({where:document.body,url:$o(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:xo,dontclear:!0},i=>new Promise(async(r,s)=>{await i.restyle({setHideOnLeave:!1});const o=w(n,"network-request-failed"),c=S().setTimeout(()=>{s(o)},Mo.get());function a(){S().clearTimeout(c),r(i)}i.ping(a).then(a,()=>{s(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jo="__/auth/handler",Yo="emulator/auth/handler",Xo=encodeURIComponent("fac");async function Jt(n,e,t,i,r,s){f(n.config.authDomain,n,"auth-domain-config-required"),f(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:fe,eventId:r};if(e instanceof vt){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",zi(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,d]of Object.entries({}))o[u]=d}if(e instanceof me){const u=e.getScopes().filter(d=>d!=="");u.length>0&&(o.scopes=u.join(","))}n.tenantId&&(o.tid=n.tenantId);const c=o;for(const u of Object.keys(c))c[u]===void 0&&delete c[u];const a=await n._getAppCheckToken(),l=a?`#${Xo}=${encodeURIComponent(a)}`:"";return`${Qo(n)}?${he(c).slice(1)}${l}`}function Qo({config:n}){return n.emulator?gt(n,Yo):`https://${n.authDomain}/${Jo}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Je="webStorageSupport";class Zo{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Wn,this._completeRedirectFn=Eo,this._overrideRedirectResult=Io}async _openPopup(e,t,i,r){var o;L((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const s=await Jt(e,t,i,it(),r);return Go(e,s,wt())}async _openRedirect(e,t,i,r){await this._originValidation(e);const s=await Jt(e,t,i,it(),r);return no(s),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:r,promise:s}=this.eventManagers[t];return r?Promise.resolve(r):(L(s,"If manager is not set, promise should be"),s)}const i=this.initAndGetManager(e);return this.eventManagers[t]={promise:i},i.catch(()=>{delete this.eventManagers[t]}),i}async initAndGetManager(e){const t=await Ho(e),i=new To(e);return t.register("authEvent",r=>(f(r==null?void 0:r.authEvent,e,"invalid-auth-event"),{status:i.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:i},this.iframes[e._key()]=t,i}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Je,{type:Je},r=>{var o;const s=(o=r==null?void 0:r[0])==null?void 0:o[Je];s!==void 0&&t(!!s),T(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Ro(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Mn()||Pn()||yt()}}const ea=Zo;var Yt="@firebase/auth",Xt="1.13.3";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function na(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function ia(n){ae(new te("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=i.options;f(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const a={apiKey:o,authDomain:c,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Un(n)},l=new Ns(i,r,s,a);return Fs(l,t),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),ae(new te("auth-internal",e=>{const t=Be(e.getProvider("auth").getImmediate());return(i=>new ta(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Y(Yt,Xt,na(n)),Y(Yt,Xt,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ra=300,sa=fn("authIdTokenMaxAge")||ra;let Qt=null;const oa=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>sa)return;const r=t==null?void 0:t.token;Qt!==r&&(Qt=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function aa(n=Jr()){const e=_n(n,"auth");if(e.isInitialized())return e.getImmediate();const t=xs(n,{popupRedirectResolver:ea,persistence:[ho,Zs,Wn]}),i=fn("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(i,location.origin);if(location.origin===s.origin){const o=oa(s.toString());Ks(t,o,()=>o(t.currentUser)),Gs(t,c=>o(c))}}const r=Di("auth");return r&&$s(t,`http://${r}`),t}function ca(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}Ds({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=r=>{const s=w("internal-error");s.customData=r,t(s)},i.type="text/javascript",i.charset="UTF-8",ca().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});ia("Browser");let x=null,Zn=null,ei=null;try{const n=bn(window.FIREBASE_CONFIG);x=aa(n),Zn=new A,ei=new k}catch(n){console.warn("[auth] Firebase unavailable, running signed-out:",(n==null?void 0:n.message)||n)}let q=null,ie=null;const st=new Set,B={get user(){return q},get profile(){return ie},get loggedIn(){return!!q},onChange(n){return st.add(n),n(q,ie),()=>st.delete(n)}};function ti(){st.forEach(n=>n(q,ie))}async function ni(){return q?q.getIdToken():null}async function ii(n,e={}){const t=await ni();return fetch(n,{...e,headers:{"Content-Type":"application/json",...e.headers||{},...t?{Authorization:`Bearer ${t}`}:{}}})}async function la(n){if(!n)return null;try{const e=await n.getIdToken(),t=await fetch(`${window.BOOK_CONFIG.baseUrl}/api/auth/sync`,{method:"POST",headers:{Authorization:`Bearer ${e}`}});if(t.ok)return await t.json()}catch(e){console.warn("Auth sync failed",e)}return{uid:n.uid,display_name:n.displayName||"",email:n.email||"",photo_url:n.photoURL||""}}x&&Js(x,async n=>{q=n,ie=n?await la(n):null,ti()});function ri(){if(!x)throw new Error("Sign-in is not configured on this server.")}async function ua(){return ri(),(await Xn(x,Zn)).user}async function da(){return ri(),(await Xn(x,ei)).user}async function Zt(){x&&await Ys(x)}async function ha({display_name:n,photo_url:e}){const t={};n!==void 0&&(t.display_name=n),e!==void 0&&(t.photo_url=e);const i=await ii(`${window.BOOK_CONFIG.baseUrl}/api/auth/profile`,{method:"PATCH",body:JSON.stringify(t)});if(!i.ok)throw new Error(await i.text());return ie=await i.json(),ti(),ie}const{baseUrl:si}=window.BOOK_CONFIG;function fa(){document.getElementById("lib-dialog")||document.body.insertAdjacentHTML("beforeend",`
...
</div>`)}function pa(){const n=document.getElementById("lib-dialog");n&&(n.classList.add("is-visible"),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("open"))),ma())}function en(){const n=document.getElementById("lib-dialog");if(!n)return;n.classList.remove("open");const e=()=>n.classList.remove("is-visible");n.addEventListener("transitionend",e,{once:!0}),setTimeout(e,300)}async function ma(){const n=document.getElementById("lib-loading");n.style.display="block",document.querySelectorAll(".lib-pane").forEach(t=>t.style.display="none");try{const t=await ii(`${si}/api/user/library`);if(!t.ok)throw new Error("Not authenticated");const i=await t.json();ve("history",ga(i.history)),ve("bookmarks",_a(i.bookmarks)),ve("notes",ba(i.notes)),ve("comments",ya(i.comments))}catch{document.getElementById("lib-pane-history").innerHTML='<p class="lib-empty">Could not load library. Please sign in.</p>'}n.style.display="none";const e=document.querySelector(".lib-tab.is-active");oi((e==null?void 0:e.dataset.tab)||"history")}function ve(n,e){document.getElementById(`lib-pane-${n}`).innerHTML=e}function oi(n){document.querySelectorAll(".lib-pane").forEach(t=>t.style.display="none");const e=document.getElementById(`lib-pane-${n}`);e&&(e.style.display="block")}function $e(n){return n?new Date(n*1e3).toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"}):""}function He(n,e){return`${si}/book/${n}?para=${e}`}function ga(n){return n!=null&&n.length?n.map(e=>`
...
<div id="auth-user-menu" class="auth-user-menu" role="menu">
...
</div>`)}function ai(n){const e=document.getElementById(n);e&&(e.classList.add("is-visible"),requestAnimationFrame(()=>requestAnimationFrame(()=>e.classList.add("open"))))}function Ue(n){const e=document.getElementById(n);if(!e)return;e.classList.remove("open");const t=()=>{e.classList.remove("is-visible")};e.addEventListener("transitionend",t,{once:!0}),setTimeout(t,300)}function ci(){J(),ai("auth-login-dialog")}function tn(){Ue("auth-login-dialog")}function li(){J(),di(),ai("auth-profile-dialog")}function wa(){Ue("auth-profile-dialog")}function Ea(){const n=document.getElementById("auth-user-menu"),e=document.getElementById("auth-avatar-btn");if(!n||!e)return;const t=e.getBoundingClientRect();n.style.top=`${t.bottom+6}px`,n.style.right=`${window.innerWidth-t.right}px`,n.classList.add("is-visible"),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("open")))}function J(){const n=document.getElementById("auth-user-menu");if(!n)return;n.classList.remove("open");const e=()=>{n.classList.remove("is-visible")};n.addEventListener("transitionend",e,{once:!0}),setTimeout(e,200)}function Sa(n){return(n||"?").trim().split(/\s+/).map(e=>{var t;return((t=e[0])==null?void 0:t.toUpperCase())||""}).join("").slice(0,2)||"?"}function ui(n,e,t){t!=null&&t.photo_url?(n.src=t.photo_url,n.hidden=!1,e.hidden=!0):(n.hidden=!0,e.hidden=!1,e.textContent=Sa(t==null?void 0:t.display_name))}function di(){const n=B.profile;n&&(document.getElementById("profile-hero-name").textContent=n.display_name||"",document.getElementById("profile-hero-email").textContent=n.email||"",document.getElementById("profile-input-name").value=n.display_name||"",document.getElementById("profile-input-photo").value=n.photo_url||"",ui(document.getElementById("profile-avatar-img"),document.getElementById("profile-avatar-initials"),n))}function Ta(n,e){const t=document.getElementById("auth-avatar-btn"),i=document.getElementById("auth-avatar-img"),r=document.getElementById("auth-avatar-initials");if(t)if(n&&e){t.classList.add("is-signed-in"),ui(i,r,e);const s=document.getElementById("auth-menu-name"),o=document.getElementById("auth-menu-email");s&&(s.textContent=e.display_name||"User"),o&&(o.textContent=e.email||"")}else t.classList.remove("is-signed-in"),i&&(i.hidden=!0),r&&(r.hidden=!1,r.textContent="👤")}function ka(){document.addEventListener("click",async n=>{var i;const e=n.target;if(e.closest("#auth-avatar-btn")){if(n.stopPropagation(),B.loggedIn){const r=document.getElementById("auth-user-menu");r!=null&&r.classList.contains("is-visible")?J():Ea()}else ci();return}const t=(i=e.closest("[data-close]"))==null?void 0:i.dataset.close;if(t){Ue(t);return}if(e.classList.contains("auth-backdrop")&&e.id){Ue(e.id);return}if(!e.closest("#auth-user-menu")&&!e.closest("#auth-avatar-btn")&&J(),e.closest("#btn-google")){we(!0);try{await ua(),tn()}catch(r){console.error("Google sign-in error:",r),nn(r.code==="auth/popup-closed-by-user"||r.code==="auth/cancelled-popup-request"?"Sign-in cancelled.":`Sign-in failed: ${r.message||r.code||"unknown error"}`)}finally{we(!1)}return}if(e.closest("#btn-facebook")){we(!0);try{await da(),tn()}catch(r){console.error("Facebook sign-in error:",r),nn(r.code==="auth/popup-closed-by-user"||r.code==="auth/cancelled-popup-request"?"Sign-in cancelled.":`Sign-in failed: ${r.message||r.code||"unknown error"}`)}finally{we(!1)}return}if(e.closest("#btn-signout")){await Zt(),wa();return}if(e.closest("#auth-menu-library-btn")){J(),pa();return}if(e.closest("#auth-menu-profile-btn")){li();return}if(e.closest("#auth-menu-signout-btn")){J(),await Zt();return}}),document.addEventListener("submit",async n=>{if(!n.target.closest("#auth-profile-form"))return;n.preventDefault();const e=document.getElementById("profile-input-name").value.trim(),t=document.getElementById("profile-input-photo").value.trim(),i=document.getElementById("profile-status");i.textContent="Saving…",i.className="auth-status-msg";try{await ha({display_name:e,photo_url:t||void 0}),i.textContent="✓ Saved",i.classList.add("success"),di()}catch(r){console.error("Profile update error:",r),i.textContent="Failed to save.",i.classList.add("error")}})}function we(n){["btn-google","btn-facebook"].forEach(e=>{const t=document.getElementById(e);t&&(t.disabled=n,t.classList.toggle("is-loading",n))})}function nn(n){const e=document.getElementById("auth-login-error");e&&(e.textContent=n,e.style.display="block")}function Aa(){va(),ka(),B.onChange(Ta)}const Ye={android:{name:"Google Play",detect:()=>/Android/i.test(navigator.userAgent),url:"https://play.google.com/store/apps/details?id=com.dn.epitaka"}},rn="epitaka_app_banner_shown",hi="epitaka_app_banner_dismissed",Ca=720*60*60*1e3,Pa=9e3,Ra=400;function La(){for(const n of Object.keys(Ye))try{if(Ye[n].detect())return Ye[n]}catch{}return null}function Oa(){try{const n=parseInt(localStorage.getItem(hi)||"0",10);return n>0&&Date.now()-n<Ca}catch{return!1}}function sn(n){n.classList.remove("show"),n.classList.add("hide"),setTimeout(()=>n.remove(),Ra)}function Na(){const n=La();if(!n)return;let e=!1;try{e=sessionStorage.getItem(rn)==="1"}catch{}if(e||Oa())return;try{sessionStorage.setItem(rn,"1")}catch{}const t=document.createElement("div");t.className="app-banner",t.setAttribute("role","status"),t.setAttribute("aria-label","E-Piṭaka mobile app"),t.innerHTML=`
  ...
  `,t.querySelector(".app-banner-close").addEventListener("click",()=>{try{localStorage.setItem(hi,String(Date.now()))}catch{}clearTimeout(i),sn(t)}),document.body.appendChild(t),requestAnimationFrame(()=>requestAnimationFrame(()=>t.classList.add("show")));const i=setTimeout(()=>sn(t),Pa)}const{bookId:St,baseUrl:ot,lang:ue,bookref:Da}=window.BOOK_CONFIG,Xe=new WeakMap,at=document.getElementById("settings-btn"),z=document.getElementById("settings-modal"),Ma=document.getElementById("settings-form"),Ua=document.getElementById("settings-cancel");_i();bi({bookId:St});const ct=window.REF_LINKS||{};console.debug("[REF_LINKS] loaded:",Object.keys(ct).length,"keys",ct);const Ae=Object.keys(ct).map(Number).sort((n,e)=>n-e);console.debug("[REF_LINKS] sorted para_ids:",Ae);function Ba(n){let e=0,t=Ae.length-1,i=-1;for(;e<=t;){const r=e+t>>>1;Ae[r]<=n?(i=Ae[r],e=r+1):t=r-1}return i}const fi=new IntersectionObserver(n=>{let e=1/0;for(const t of n){if(!t.isIntersecting)continue;const i=t.target.id,r=i&&i.match(/^p-(\d+)-l-\d+$/);if(r){const s=parseInt(r[1]);s<e&&(e=s)}}if(e<1/0){const t=Ba(e);console.debug("[sentinel] visible sentence para_id:",e,"→ nearest ref:",t),t>0&&$a(t)}},{rootMargin:"0px 0px -10% 0px"});function xa(){document.querySelectorAll(".section-content.open .sentence-row").forEach(n=>fi.observe(n))}xa();function lt(n){document.querySelectorAll(".pali-text, .book-link-badge").forEach(e=>{Xe.has(e)||Xe.set(e,e.innerHTML);const t=Xe.get(e);e.innerHTML=n===Ti.RO?t:Fa(t,n)})}function Fa(n,e){return n.replace(/(<[^>]+>)|([^<]+)/g,(t,i,r)=>i||Tt.convert(Tt.convertFromMixed(r),e))}function $a(n){const e=["mula_ref","attha_ref","tika_ref"],t={mula_ref:"ref-mula",attha_ref:"ref-attha",tika_ref:"ref-tika"},r=(window.REF_LINKS||{})[n];if(r)for(const s of e){const o=r[s]||[];for(let c=0;c<o.length;c++){const a=document.getElementById(`${t[s]}-${c+1}`);if(a){const l=o[c],u=[ue,"book",l.book_id,l.slug].filter(Boolean).join("/");a.href=ot+"/"+u+"#"+l.para_id}}}else for(const s of e){const o=Da[s]||[];for(let c=0;c<o.length;c++){const a=document.getElementById(`${t[s]}-${c+1}`);a&&(a.href=`${ot}/${ue}/book_ref/${o[c].book_id}?ref=${St}&para_id=${n}`)}}mi()}function pi(){const n=document.body.getAttribute("data-flow")==="true";document.querySelectorAll(".para-group").forEach(e=>{let t=e.querySelector(".book-links-end");if(n){const i=e.querySelectorAll(".sentence-row .book-link-badge, .sentence-row .book-link-more");if(!i.length)return;t||(t=document.createElement("div"),t.className="book-links-end",e.appendChild(t)),t.innerHTML="",i.forEach(r=>t.appendChild(r.cloneNode(!0)))}else t&&t.remove()})}at.addEventListener("click",n=>{if(n.stopPropagation(),window.innerWidth<768){const t=document.getElementById("topbar-more-menu"),i=t==null?void 0:t.classList.contains("open");t==null||t.classList.toggle("open"),at.setAttribute("aria-expanded",!i)}else{const t=Ce();on(t),ut(document.getElementById("pali-script-select"),t.paliScript),z.classList.add("show")}});Ua.addEventListener("click",()=>z.classList.remove("show"));z.addEventListener("click",n=>{n.target===z&&z.classList.remove("show")});Ma.addEventListener("submit",n=>{n.preventDefault();const e=yi();e.scriptManuallySet=!0,Ii(e),vi(e.theme),an(e),lt(e.paliScript),pi(),z.classList.remove("show")});function mi(){var o;const n=document.getElementById("ref-mula-1"),e=document.getElementById("ref-attha-1"),t=document.getElementById("ref-tika-1"),i=document.getElementById("ref-mula-mobile"),r=document.getElementById("ref-attha-mobile"),s=document.getElementById("topbar-more-tika-group");n&&i&&(i.href=n.href),e&&r&&(r.href=e.href),t&&s&&!s.querySelector(".topbar-more__tika-menu")&&((o=s.querySelector(".topbar-more__ref-btn"))==null||o.setAttribute("href",t.href))}function Ha(){var o,c;const n=document.getElementById("topbar-more-menu");if(!n)return;function e(){n.classList.remove("open"),at.setAttribute("aria-expanded","false")}(o=n.querySelector(".topbar-more__settings"))==null||o.addEventListener("click",a=>{a.stopPropagation(),e();const l=Ce();on(l),ut(document.getElementById("pali-script-select"),l.paliScript),z.classList.add("show")}),(c=n.querySelector(".topbar-more__auth"))==null||c.addEventListener("click",a=>{a.stopPropagation(),e(),B.loggedIn?li():ci()}),document.addEventListener("click",a=>{a.target.closest("#topbar-more")||e()}),document.addEventListener("keydown",a=>{a.key==="Escape"&&n.classList.contains("open")&&e()}),n.querySelectorAll(".topbar-more__link").forEach(a=>{a.addEventListener("click",e)});const t=document.getElementById("topbar-more-tika-group"),i=t==null?void 0:t.querySelector(".topbar-more__tika-menu"),r=t==null?void 0:t.querySelector(".topbar-more__ref-btn");r&&i&&(r.addEventListener("click",a=>{a.stopPropagation();const l=i.classList.contains("open");i.classList.toggle("open"),r.setAttribute("aria-expanded",!l)}),document.addEventListener("click",a=>{a.target.closest("#topbar-more-tika-group")||(i.classList.remove("open"),r==null||r.setAttribute("aria-expanded","false"))}));function s(a){const l=n.querySelector(".topbar-more__auth");l&&(B.loggedIn&&a?l.textContent="👤 "+(a.display_name||"Profile"):l.textContent="👤 Login")}B.onChange(s)}function Va(){if(!window.BOOK_CONFIG)return;const{baseUrl:n,bookId:e}=window.BOOK_CONFIG;let t=null,i=null,r=null;function s(c){i=c,B.loggedIn&&c!==t&&(t=c,clearTimeout(r),r=setTimeout(async()=>{var p,m;const a=document.querySelector(`.section-block[data-para-id="${c}"]`),l=a==null?void 0:a.querySelector(".section-heading-text"),u=((p=l==null?void 0:l.textContent)==null?void 0:p.trim())||"",d=document.querySelector(".book-title"),h=((m=d==null?void 0:d.textContent)==null?void 0:m.trim())||"";try{const _=await ni();if(!_)return;fetch(`${n}/api/book/${e}/history`,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${_}`},body:JSON.stringify({para_id:c,section_title:u,book_title:h})})}catch{}},5e3))}const o=new IntersectionObserver(c=>{for(const a of c){if(!a.isIntersecting)continue;const l=parseInt(a.target.dataset.paraId);isNaN(l)||s(l)}},{rootMargin:"-10% 0px -50% 0px"});document.querySelectorAll(".section-block").forEach(c=>o.observe(c)),B.onChange(c=>{c&&i!==null&&s(i)})}async function Wa(){try{const n=await fetch(`${ot}/api/book/${St}/heading_translations?lang=${encodeURIComponent(ue)}`);if(!n.ok)return;const e=await n.json();for(const[t,i]of Object.entries(e)){const r=document.querySelector(`.section-block[data-para-id="${t}"]`);if(!r)continue;let s=r.querySelector(".section-heading-translation");if(!s){const o=r.querySelector(".section-heading-link, .section-heading-empty");if(!o)continue;s=document.createElement("span"),s.className="section-heading-translation",o.appendChild(s)}s.innerHTML=i}}catch(n){console.debug("[book] failed to fetch heading translations",n)}}document.addEventListener("DOMContentLoaded",async()=>{wi(document.getElementById("main-content"));const n=Ce(ue);an(n),lt(n.paliScript),ut(document.getElementById("pali-script-select"),n.paliScript),pi(),document.querySelectorAll(".lang-dropdown__menu a").forEach(u=>{u.addEventListener("click",d=>{var p;const h=(p=u.getAttribute("href"))==null?void 0:p.match(/\/([a-z]{2})\b/);h&&Ei(h[1])})});{const u=document.querySelector(".lang-dropdown__menu"),d=u==null?void 0:u.querySelector(".lang-dropdown__filter");if(u&&d){const h=[...u.querySelectorAll(".lang-dropdown__list > li")],p=u.querySelector(".lang-dropdown__empty");d.addEventListener("input",()=>{const m=d.value.trim().toLowerCase();let _=0;for(const b of h){const I=!m||(b.dataset.search||b.textContent).toLowerCase().includes(m);b.hidden=!I,I&&_++}p&&(p.hidden=_!==0)})}}Aa(),Ia(),Na(),Si({gaId:"G-7NQWX1DCC2"}),Ha(),Va(),Wa(),mi(),document.addEventListener("sidebar:library-ready",()=>{const u=Ce(ue);lt(u.paliScript)});function e(u){const d=document.querySelectorAll(".section-block");let h=null;for(const p of d){const m=parseInt(p.dataset.paraId);!isNaN(m)&&m<=u&&(h=p)}return h}function t(u){return[...document.querySelectorAll(".sentence-row")].find(h=>{const p=h.id.match(/^p-(\d+)-l-(\d+)$/);return p&&parseInt(p[1],10)===u})||null}function i(u,d){const h=document.getElementById(`p-${u}-l-${d}`);return(h==null?void 0:h.id)===`p-${u}-l-${d}`?h:null}function r(u){if(!u)return;const d=u.querySelector(".section-content");d&&!d.classList.contains("open")&&(d.classList.add("open"),d.setAttribute("aria-hidden","false"),d.querySelectorAll(".sentence-row").forEach(h=>fi.observe(h)))}function s(){document.querySelectorAll(".jump-target-highlight").forEach(u=>{u.classList.remove("jump-target-highlight")})}function o(u,d){var I;if(!u||!d)return;const h=d.trim();if(!h)return;const p=h.toLocaleLowerCase(),m=document.createTreeWalker(u,NodeFilter.SHOW_TEXT),_=[];let b;for(;b=m.nextNode();)(I=b.parentElement)!=null&&I.closest("script, style, mark")||b.nodeValue.toLocaleLowerCase().includes(p)&&_.push(b);_.forEach(H=>{const _e=H.nodeValue,gi=_e.toLocaleLowerCase(),be=document.createDocumentFragment();let ye=0,se;for(;(se=gi.indexOf(p,ye))!==-1;){be.append(_e.slice(ye,se));const Ve=document.createElement("mark");Ve.className="jump-search-term",Ve.textContent=_e.slice(se,se+h.length),be.append(Ve),ye=se+h.length}be.append(_e.slice(ye)),H.replaceWith(be)})}function c(u,d=""){requestAnimationFrame(()=>{s();const h=u.closest(".para-group")||u;h.classList.remove("jump-target-highlight"),h.offsetWidth,h.classList.add("jump-target-highlight"),o(h,d),u.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>h.classList.remove("jump-target-highlight"),5e3)})}document.addEventListener("click",u=>{const d=u.target.closest("a[href]");if(!d||d.target==="_blank")return;let h;try{h=new URL(d.href,window.location.href)}catch{return}if(h.origin!==window.location.origin||h.pathname!==window.location.pathname)return;const p=h.hash.replace(/^#/,"");if(!p)return;const m=p.split("-"),_=parseInt(m[0],10);if(isNaN(_))return;const b=parseInt(m[1],10);let I=isNaN(b)?t(_):i(_,b);if(!I){const H=e(_);r(H),I=isNaN(b)?t(_)||H:i(_,b)}I&&(u.preventDefault(),history.pushState(null,"",h.hash),c(I,h.searchParams.get("q")||""))});const a=window.location.hash.replace(/^#/,""),l=new URLSearchParams(window.location.search).get("q")||"";if(a){const u=a.split("-"),d=parseInt(u[0]),h=u.length>=2?parseInt(u[1]):NaN;if(!isNaN(d))if(isNaN(h)){let p=t(d);if(!p){const m=e(d);r(m),p=t(d)}if(p)c(p,l);else{const m=e(d);m&&c(m,l)}}else{let p=i(d,h);if(!p){const m=e(d);r(m),p=i(d,h)}if(p)c(p,l);else{const m=e(d);m&&c(m,l)}}}else if(window.BOOK_CONFIG.paraId){const u=e(window.BOOK_CONFIG.paraId);u&&setTimeout(()=>{u.scrollIntoView({behavior:"smooth",block:"start"})},200)}});
