import{a as A,c as q,b as B,H as x,d as H,j as C}from"./cookie-consent.chunk.js";function j(l,t){if(!t)return l;const o=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return l.replace(new RegExp(`(${o})`,"gi"),"<mark>$1</mark>")}const S=["Mūla","Aṭṭhakathā","Ṭīkā"],M=["Vinaya","Suttanta","Sutta","Abhidhamma"];class N{constructor({baseUrl:t,lang:o,menu:e,onNavigate:s}){this.baseUrl=t,this.lang=o,this.menu=e,this.onNavigate=s,this._filterText=""}buildHTML(){const t=this._resolvedCategories(),o=t.map((s,n)=>`
