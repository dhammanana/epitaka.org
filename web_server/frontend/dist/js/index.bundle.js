import{a as B,c as H,b as C,H as M,l as j,S as w,T,d as O,j as N,o as R}from"./cookie-consent-LVKrRp8B.chunk.js";function P(r,t){if(!t)return r;const a=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return r.replace(new RegExp(`(${a})`,"gi"),"<mark>$1</mark>")}const I=["Mūla","Aṭṭhakathā","Ṭīkā"],D=["Vinaya","Suttanta","Sutta","Abhidhamma"];class F{constructor({baseUrl:t,lang:a,menu:e,onNavigate:o}){this.baseUrl=t,this.lang=a,this.menu=e,this.onNavigate=o,this._filterText=""}buildHTML(){const t=this._resolvedCategories(),a=t.map((o,s)=>`
    ...
    `).join(""):""}}class Q{constructor(t,a){this._key=t,this._defaults=a,this._data=this._load()}get(t){return this._data[t]}set(t,a){this._data[t]=a,this._save()}patch(t){Object.assign(this._data,t),this._save()}snapshot(){return{...this._data}}_load(){try{const t=localStorage.getItem(this._key);return t?{...this._defaults,...JSON.parse(t)}:{...this._defaults}}catch{return{...this._defaults}}}_save(){try{localStorage.setItem(this._key,JSON.stringify(this._data))}catch{}}}function K({triggerSelector:r,baseUrl:t,lang:a,menu:e,hierarchy:o}){var k;if(document.getElementById("home-dialog-overlay"))return;const s=document.querySelector(r);if(!s){console.warn("[HomeDialog] trigger not found:",r);return}const n=new Q("homeDialog_state",{searchQuery:"",searchTypeId:((k=B[0])==null?void 0:k.id)??"",activeTabId:null}),l=o||W(e||{}),d=new F({baseUrl:t,lang:a,menu:e||{},onNavigate:i=>{y(),window.location.href=i}}),g=new H({baseUrl:t,lang:a,hierarchy:l,initialState:{searchTypeId:n.get("searchTypeId")},onResultSelect:i=>{y(),window.location.href=i},onShowResults:()=>q(),onShowBooks:()=>x()}),u=document.createElement("div");u.id="home-dialog-overlay",u.setAttribute("role","dialog"),u.setAttribute("aria-modal","true"),u.setAttribute("aria-label","Browse books"),u.innerHTML=`
    <div id="home-dialog" role="document">
      ...
      <div id="home-dialog-header">
        ...
        ${C(M,n.get("searchTypeId"),n.get("searchQuery"))}
